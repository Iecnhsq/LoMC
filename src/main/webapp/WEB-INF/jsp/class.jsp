...
<div class="comdiv">
    ...
    <p>
        <img src="src/img/icon-hunter.png" class="leftimg"/>
    ...
    <p>
        <img src="src/img/icon-mage.png" class="leftimg"/>
    ...
    <p>
        <img src="src/img/icon-priest.png" class="leftimg"/>
    ...
    <p>
        <img src="src/img/icon-rogue.png" class="leftimg"/>
    ...
    <p>
        <img src="src/img/icon-shaman.png" class="leftimg"/>
    ...
    <p>
        <img src="src/img/icon-warrior.png" class="leftimg"/>
